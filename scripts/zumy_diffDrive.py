...
class DiffDriveController(object):
    ...
    def setup(self):
      ...
      #init node
      rospy.init_node('zumy_diffdrive_controller_node', anonymous=True)
      ...
      self.publish_commands= rospy.Publisher('/odroid2/cmd_vel', Twist, queue_size=5)
