...
def main():
    ...
    #initialize model
    dyn_model = Dyn_Model(inputSize, outputSize, lr, batchsize, 0, x_index, y_index, 
                        num_fc_layers, depth_fc_layers, mean_x, mean_y, mean_z, 
                        std_x, std_y, std_z, tf_datatype, np_datatype, print_minimal, feedforward_network, train_now, model_name, config,
